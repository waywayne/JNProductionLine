...
class TestState extends ChangeNotifier {
  ...
  List<Map<String, dynamic>> _getTestSequence() {
    return [
      ...
      // ========== 其他功能测试 ==========
      {'name': '17. EMMC容量检测测试', 'type': 'EMMC', 'executor': _autoTestEMMCCapacity, 'skippable': false},
      {'name': '18. 设备电压测试', 'type': '电压', 'executor': _autoTestVoltage, 'skippable': false},
      {'name': '19. 电量检测测试', 'type': '电量', 'executor': _autoTestBattery, 'skippable': false},
      {'name': '20. 充电状态测试', 'type': '充电', 'executor': _autoTestCharging, 'skippable': false},
      {'name': '21. 生成设备标识', 'type': '标识', 'executor': _autoTestGenerateDeviceId, 'skippable': false},
      // {'name': '22. SPP蓝牙功能测试', 'type': '蓝牙', 'executor': _autoTestSppBluetooth, 'skippable': false},
      {'name': '23. WiFi功能测试', 'type': 'WiFi', 'executor': _autoTestWiFi, 'skippable': false},
      {'name': '24. Sensor测试', 'type': 'Sensor', 'executor': _autoTestSensor, 'skippable': false},
      {'name': '25. RTC设置时间测试', 'type': 'RTC', 'executor': _autoTestRTCSet, 'skippable': false},
      {'name': '26. RTC获取时间测试', 'type': 'RTC', 'executor': _autoTestRTCGet, 'skippable': false},
      {'name': '27. 光敏传感器测试', 'type': '光敏', 'executor': _autoTestLightSensor, 'skippable': false},
      {'name': '28. IMU传感器测试', 'type': 'IMU', 'executor': _autoTestIMU, 'skippable': false},
      {'name': '29. 右触控测试', 'type': 'Touch', 'executor': _autoTestRightTouch, 'skippable': false},
      {'name': '30. 左触控测试', 'type': 'Touch', 'executor': _autoTestLeftTouch, 'skippable': false},
      {'name': '31. LED灯(外侧)测试', 'type': 'LED', 'executor': () => _autoTestLEDWithDialog('外侧'), 'skippable': false},
      {'name': '32. LED灯(内侧)测试', 'type': 'LED', 'executor': () => _autoTestLEDWithDialog('内侧'), 'skippable': false},
      {'name': '33. 左SPK测试', 'type': 'SPK', 'executor': () => _autoTestSPK(0), 'skippable': false},
      {'name': '34. 右SPK测试', 'type': 'SPK', 'executor': () => _autoTestSPK(1), 'skippable': false},
      {'name': '35. 左MIC测试', 'type': 'MIC', 'executor': () => _autoTestMICRecord(0), 'skippable': false},
      {'name': '36. 右MIC测试', 'type': 'MIC', 'executor': () => _autoTestMICRecord(1), 'skippable': false},
      {'name': '37. TALK MIC测试', 'type': 'MIC', 'executor': () => _autoTestMICRecord(2), 'skippable': false},
      {'name': '38. 蓝牙功能测试', 'type': '蓝牙', 'executor': _autoTestBluetooth, 'skippable': false},
      {'name': '39. 结束产测', 'type': '电源', 'executor': _autoTestPowerOff, 'skippable': false},
    ];
  }  
  ...
  Future<void> _executeAllTests() async {
    // 定义完整测试序列 - 调整顺序：产测开始后优先处理 SN、MAC 地址和硬件版本号
    final testSequence = [
      {'name': '1. 设备关机', 'type': '电源', 'executor': _autoTestShutdown, 'skippable': false},
      {'name': '2. 漏电流测试', 'type': '电流', 'executor': _autoTestLeakageCurrent, 'skippable': false},
      {'name': '3. 上电测试', 'type': '电源', 'executor': _autoTestPowerOn, 'skippable': false},
